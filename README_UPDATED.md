# OPA Policies for Spring Boot Application - Expanded Edition

## Overview

This project demonstrates how to integrate Open Policy Agent (OPA) with a Spring Boot application to enforce comprehensive access control policies. It serves as a learning playground for Java developers to use AI-assisted tools (like GitHub Copilot) to generate OPA policies and test cases from English descriptions.

**New in this expansion**: 19 additional endpoints demonstrating advanced OPA features including resource ownership, time-based policies, cross-resource validation, and policy composition.
...
├── main/
│   ├── java/
│   │   └── com/capgemini/opapolicies/
│   │       ├── api/                    # REST Controllers
│   │       │   ├── FoodController.java           # Original food endpoints
│   │       │   ├── EnhancedFoodController.java   # NEW: Enhanced food management
│   │       │   ├── RecipeController.java         # NEW: Recipe management
│   │       │   ├── MealPlanController.java       # NEW: Meal planning
│   │       │   └── UserProfileController.java    # NEW: User profiles
│   │       ├── domain/                 # Domain Models
│   │       │   ├── FoodItem.java                 # NEW: Enhanced food model
│   │       │   ├── Recipe.java                   # NEW: Recipe model
│   │       │   ├── MealPlan.java                 # NEW: Meal plan model
│   │       │   └── ...
│   │       ├── service/                # Business Logic
│   │       │   ├── FoodService.java              # NEW: Food operations
│   │       │   ├── RecipeService.java            # NEW: Recipe operations
│   │       │   ├── MealPlanService.java          # NEW: Meal planning
│   │       │   └── UserProfileService.java       # NEW: User profiles
│   │       └── security/               # Security Configuration
│   │           ├── OPAConfiguration.java
│   │           └── OPAAuthorizationManager.java
│   └── policies/
│       ├── policy.rego                 # Original food policies
│       ├── food_enhanced_security.rego # NEW: Enhanced food policies
│       ├── recipe_security.rego        # NEW: Recipe policies
│       ├── meal_plan_security.rego     # NEW: Meal plan policies
│       ├── user_profile_security.rego  # NEW: User profile policies
│       └── combined_enhanced.rego      # NEW: Policy composition
└── test/
    ├── java/
    │   └── com/capgemini/opapolicies/api/
    │       ├── FoodControllerSecurityTest.java
    │       ├── EnhancedFoodControllerSecurityTest.java    # NEW
    │       ├── RecipeControllerSecurityTest.java          # NEW
    │       ├── MealPlanControllerSecurityTest.java        # NEW
    │       └── UserProfileControllerSecurityTest.java     # NEW
    └── policies/
        ├── test_policy.rego
        └── test_enhanced_policies.rego                    # NEW
```
...
3. Verify Keycloak is running: `curl http://localhost:8080/health`
